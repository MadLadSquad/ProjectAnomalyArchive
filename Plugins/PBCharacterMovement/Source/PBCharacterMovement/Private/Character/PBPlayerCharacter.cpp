...
//auto result = discord::Core::Create(697420452712284202, DiscordCreateFlags_Default, &core);
//discord::Activity activity{};
//activity.SetState("Pre-Alpha Testing");
//if (GetWorld()->GetName() == "E1M1" || GetWorld()->GetName() == "E1M2" || GetWorld()->GetName() == "E1M3" || GetWorld()->GetName() == "E1M4" || GetWorld()->GetName() == "E1M5")
//{
//	activity.SetDetails("Story Mode");
//}
//else if (GetWorld()->GetName() == "S1M1" || GetWorld()->GetName() == "S1M2" || GetWorld()->GetName() == "S1M3" || GetWorld()->GetName() == "S1M4" || GetWorld()->GetName() == "S1M5")
//{
//	activity.SetDetails("Vanilla Multiplayer");
//}
//else if (GetWorld()->GetName() == "Tutorial")
//{
//	activity.SetDetails("Tutorial");
//}
//else
//{
//	activity.SetDetails("Custom Level/Game Mode");
//}
